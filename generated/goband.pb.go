...
var File_goband_proto protoreflect.FileDescriptor
...
var (
	file_goband_proto_rawDescOnce sync.Once
	file_goband_proto_rawDescData = file_goband_proto_rawDesc
)

func file_goband_proto_rawDescGZIP() []byte {
	file_goband_proto_rawDescOnce.Do(func() {
		file_goband_proto_rawDescData = protoimpl.X.CompressGZIP(file_goband_proto_rawDescData)
	})
...
func init() { file_goband_proto_init() }
func file_goband_proto_init() {
	if File_goband_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_goband_proto_goTypes,
		DependencyIndexes: file_goband_proto_depIdxs,
		MessageInfos:      file_goband_proto_msgTypes,
	}.Build()
	File_goband_proto = out.File
	file_goband_proto_rawDesc = nil
	file_goband_proto_goTypes = nil
	file_goband_proto_depIdxs = nil
}
